    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="education_block_grid">
                ...
                <div class="education_block_thumb">
                    <a href="course-detail.html"><img src="<?php echo get_template_directory_uri().'/assets/image/course-1.jpg' ?>" class="img-fluid" alt=""></a>
                ...
                <div class="education_block_body">
                    ...
                    <p> تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد.</p>
                </div>

                <div class="education_block_footer">
                    <div class="education_block_author">
                        <div class="path-img"><a href="instructor-detail.html"><img src="<?php echo get_template_directory_uri().'/assets/image/user-1.jpg' ?>" class="img-fluid" alt=""></a></div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="education_block_grid">
                ...
                <div class="education_block_thumb">
                    <a href="course-detail.html"><img src="<?php echo get_template_directory_uri().'/assets/image/course-2.jpg' ?>" class="img-fluid" alt=""></a>
                ...
                <div class="education_block_footer">
                    <div class="education_block_author">
                        <div class="path-img"><a href="instructor-detail.html"><img src="<?php echo get_template_directory_uri().'/assets/image/user-2.jpg' ?>" class="img-fluid" alt=""></a></div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="education_block_grid">
                ...
                <div class="education_block_thumb">
                    <a href="course-detail.html"><img src="<?php echo get_template_directory_uri().'/assets/image/course-3.jpg' ?>" class="img-fluid" alt=""></a>
                <div class="topic_level bg-warning text-white">جاوااسکریپت</div>
                </div>
                ...
                <div class="education_block_footer">
                    <div class="education_block_author">
                        <div class="path-img"><a href="instructor-detail.html"><img src="<?php echo get_template_directory_uri().'/assets/image/user-3.jpg' ?>" class="img-fluid" alt=""></a></div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="education_block_grid">
                ...
                <div class="education_block_thumb">
                    <a href="course-detail.html"><img src="<?php echo get_template_directory_uri().'/assets/image/course-4.jpg' ?>" class="img-fluid" alt=""></a>
                ...
                <div class="education_block_footer">
                    <div class="education_block_author">
                        <div class="path-img"><a href="instructor-detail.html"><img src="<?php echo get_template_directory_uri().'/assets/image/user-4.jpg' ?>" class="img-fluid" alt=""></a></div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="education_block_grid">
                ...
                <div class="education_block_thumb">
                    <a href="course-detail.html"><img src="<?php echo get_template_directory_uri().'/assets/image/course-5.jpg' ?>" class="img-fluid" alt=""></a>
                ...
                <div class="education_block_footer">
                    <div class="education_block_author">
                        <div class="path-img"><a href="instructor-detail.html"><img src="<?php echo get_template_directory_uri().'/assets/image/user-5.jpg' ?>" class="img-fluid" alt=""></a></div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="education_block_grid">
                ...
                <div class="education_block_thumb">
                    <a href="course-detail.html"><img src="<?php echo get_template_directory_uri().'/assets/image/course-6.jpg' ?>" class="img-fluid" alt=""></a>
            <div class="topic_level bg-warning text-white">وردپرس</div>
                ...
                <div class="education_block_footer">
                    <div class="education_block_author">
                        <div class="path-img"><a href="instructor-detail.html"><img src="<?php echo get_template_directory_uri().'/assets/image/user-6.jpg' ?>" class="img-fluid" alt=""></a></div>
