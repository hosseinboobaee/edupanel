...
include_once 'helper-class/ReadStimateTime.php';
include_once 'helper-class/GoogleReferer.php';
include_once 'helper-class/TimeModify.php';
include_once '_inc/widgets/sidebar-widget.php';
include_once '_inc/widgets/HotPostWidget.php';
include_once '_inc/widgets/CatsWidget.php';
